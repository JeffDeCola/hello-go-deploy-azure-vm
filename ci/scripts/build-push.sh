...
cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-azure-vm/example-01-azure-vm/bin/hello-go" .
echo " "

echo "cp the Dockerfile into /dist"
cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-azure-vm/example-01-azure-vm/build-push/Dockerfile" .
echo " "
